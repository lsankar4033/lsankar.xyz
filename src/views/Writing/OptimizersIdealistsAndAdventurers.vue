<template>
  <div id="post">
    <br />
    <h2 id="title">Optimizers, idealists, and adventurers</h2>
    ...
    <p>
      ...
      <strong>real decision making</strong> when combined with other mental
      models.
    </p>
    <br />
    ...
    <p>
      ...
      a conversation with
      <a href="https://raymondcheng.net/blog/">Ray Cheng</a> in late 2019. Ray
...
<script>
export default {
  name: "OptimizersIdealistsAndAdventurers"
};
</script>
